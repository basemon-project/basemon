Contributing to basemon Core
============================

The basemon Core project operates an open contributor model where anyone is
...
The following applies to code changes to the basemon Core project, and is not to be
confused with overall basemon Network Protocol consensus changes.

Whether a pull request is merged into basemon Core rests with the project merge
...
Patches that change basemon consensus rules are considerably more involved than
...
Where a patch set proposes to change the basemon consensus, it must have been
...
The project leader is the release manager for each basemon Core release.
