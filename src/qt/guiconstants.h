...
/* basemon GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "basemon"
#define QAPP_ORG_DOMAIN "basemonproject.org"
#define QAPP_APP_NAME_DEFAULT "basemon-Qt"
#define QAPP_APP_NAME_TESTNET "basemon-Qt-testnet"
