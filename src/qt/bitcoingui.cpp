                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("basemon Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&basemon Project"), this);
    webmainAction->setStatusTip(tr("basemon Project Website"));
    ...
    facebookAction->setStatusTip(tr("basemon Facebook"));
    ...
    twitterAction->setStatusTip(tr("basemon Twitter"));
    ...
    discordAction->setStatusTip(tr("basemon Discord"));
    ...
    youtubeAction->setStatusTip(tr("basemon Youtube"));
    ...
    telegramAction->setStatusTip(tr("basemon Telegram"));
    ...
    redditAction->setStatusTip(tr("basemon Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap basemon"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell basemon Coin (basemon)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    basemonBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&basemon block explorer"), this);
    basemonBlockExplorerAction->setStatusTip(tr("basemon blockchain explorer"));
    basemonBlockExplorerAction->setToolTip(basemonBlockExplorerAction->statusTip());
    basemonBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&basemon Project Github"), this);
    githubAction->setStatusTip(tr("basemon Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a basemon address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and basemon: URIs)"));
...
//    }
    ...
    connect(basemonBlockExplorerAction, SIGNAL(triggered()), this, SLOT(basemonBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About basemon Core"), this);
    aboutAction->setStatusTip(tr("Show information about basemon Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for basemon"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your basemon addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified basemon addresses"));
    ...
    openAction->setStatusTip(tr("Open a basemon: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the basemon Core help message to get a list with possible basemon command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(basemonBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("basemon Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.basemon.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/basemon.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/basemon4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/basemoncryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/basemon-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::basemonBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/basemon/basemon/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to basemon network", "", count));
}
...
{
    QString strTitle = tr("basemon Core"); // default title
