...
/** Utility functions used by the basemon Qt UI.
 */
namespace GUIUtil
{
...
// Render basemon addresses in monospace font
...
// Parse "basemon:" URI into recipient object, return true on successful parsing
