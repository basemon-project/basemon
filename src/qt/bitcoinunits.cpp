...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case basemon:
            return QString("BMC");
        case mECA:
            return QString("Milli-BMC(1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-BMC(1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case basemon:
            return QString("TestBMCs");
        case mECA:
            return QString("Milli-TestBMC (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-TestBMC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
