...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // 1 minutes
        ...
        const char* pszTimestamp = "basemon is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1629196434;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 3368121;
        ...
        assert(genesis.hashMerkleRoot == uint256("0xa716082b550186b82dc465d557582b2d5674f9fbd20d2c14680022f8e8c0ca0e"));
        assert(hashGenesisBlock == uint256("0x000008e5a32fefdfcdcaa0f3c18b4935a205978ba9514023d370dfd7e49750c5"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xa716082b550186b82dc465d557582b2d5674f9fbd20d2c14680022f8e8c0ca0e"));
        assert(hashGenesisBlock == uint256("0x000053d0615b83dd9f0ffc296eca5ee1fba7c27d1fd87a2fc851031c6b0e297a"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xa716082b550186b82dc465d557582b2d5674f9fbd20d2c14680022f8e8c0ca0e"));
        assert(hashGenesisBlock == uint256("0x051669d2e298578784d45461eff7a3d8651fca8cd3e9fdadbb75f474bb44db28"));
