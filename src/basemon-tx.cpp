...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("basemon basemon-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  basemon-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded basemon transaction") + "\n" +
                               "  basemon-tx [options] -create [commands]   " + _("Create hex-encoded basemon transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded basemon transaction
