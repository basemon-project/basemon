...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "basemon server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* basemon features */
        {"basemon", "masternode", &masternode, true, true, false},
        {"basemon", "listmasternodes", &listmasternodes, true, true, false},
        {"basemon", "getmasternodecount", &getmasternodecount, true, true, false},
        {"basemon", "masternodeconnect", &masternodeconnect, true, true, false},
        {"basemon", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"basemon", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"basemon", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"basemon", "masternodecurrent", &masternodecurrent, true, true, false},
        {"basemon", "masternodedebug", &masternodedebug, true, true, false},
        {"basemon", "startmasternode", &startmasternode, true, true, false},
        {"basemon", "createmasternodekey", &createmasternodekey, true, true, false},
        {"basemon", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"basemon", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"basemon", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"basemon", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"basemon", "getmasternodescores", &getmasternodescores, true, true, false},
        {"basemon", "mnbudget", &mnbudget, true, true, false},
        {"basemon", "preparebudget", &preparebudget, true, true, false},
        {"basemon", "submitbudget", &submitbudget, true, true, false},
        {"basemon", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"basemon", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"basemon", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"basemon", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"basemon", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"basemon", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"basemon", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"basemon", "checkbudgets", &checkbudgets, true, true, false},
        {"basemon", "mnsync", &mnsync, true, true, false},
        {"basemon", "spork", &spork, true, true, false},
        {"basemon", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> basemon-cli " + methodname + " " + args + "\n";
}
