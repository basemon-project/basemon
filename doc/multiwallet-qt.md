...
In order to support loading of multiple wallets in basemon-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is basemon.cpp.
...
Changes to basemon.cpp
----------------------
basemon.cpp is the entry point into basemon-qt, and as such, will require some minor modifications to provide hooks for
