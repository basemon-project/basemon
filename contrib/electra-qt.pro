...
RESOURCES += src/qt/basemon.qrc src/qt/basemon_locale.qrc

TRANSLATIONS += src/qt/locale/basemon_bg.ts \
                src/qt/locale/basemon_de.ts \
                src/qt/locale/basemon_en.ts \
                src/qt/locale/basemon_es.ts \
                src/qt/locale/basemon_fi.ts \
                src/qt/locale/basemon_fr.ts \
                src/qt/locale/basemon_it.ts \
                src/qt/locale/basemon_ja.ts \
                src/qt/locale/basemon_pl.ts \
                src/qt/locale/basemon_pt.ts \
                src/qt/locale/basemon_ru.ts \
                src/qt/locale/basemon_sk.ts \
                src/qt/locale/basemon_sv.ts \
                src/qt/locale/basemon_vi.ts \
                src/qt/locale/basemon_zh_CN.ts \
                src/qt/locale/basemon_zh_TW.ts
